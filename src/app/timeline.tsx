...
const jobs = [
  { date: "July 2022 - Present", title: "Software Engineer", company: "Sivers Photonics" },
  { date: "February 2025 - Present", title: "Software Engineer", company: "gdsfactory" },
];
    ...
    <div className="flex flex-col items-center p-8">
      ...
      {selectedJob !== null && (
        <div className="mt-6 p-4 bg-gray-100 rounded-lg shadow-md">
          <h2 className="text-xl font-bold">{jobs[selectedJob].company}</h2>

  ...
  return (
    <div>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600 mb-4">Developed full-stack CAD automation software for efficient design of advanced DFB lasers.</p>
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
          <li>Built the internal software for Sivers that now handles the majority of CAD automation processes and yielding a notable reduction of over <strong>50%</strong> in product design and creation timelines. This enhancement has significantly improved operational efficiency and customer satisfaction.</li>
          <li>Contributed to the development of advanced photonics technology.</li>
          <li>Utilized GitHub Actions to automate CI/CD workflows, enabling continuous integration, deployment, and automated testing. This ensured consistent quality checks, rapid feedback on code changes, and a reliable development pipeline.</li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600">Acquired knowledge in software engineering at JP Morgan through practical workshops, expert panels, and networking.</p>
      </section>
    </div>
  )
} 